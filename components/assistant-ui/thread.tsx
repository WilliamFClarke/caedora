...
export const Thread: FC = () => {
  ...
  const handleScroll = useCallback(() => {
    const scrollElement = scrollRef.current;
    if (!scrollElement) return;
    setIsAtBottom(isNearBottom(scrollElement));
  }, [setIsAtBottom]);
  ...
  }, [messageCount, isRunning, scrollToBottom]);
      ...
      >
        ...
        >
          <div
            ...
            className="mx-auto flex min-h-full w-full max-w-(--thread-max-width) flex-col px-4 pt-4"
          >
...
const ThreadScrollToBottom: FC<{
  ...
  return (
    <TooltipIconButton
      ...
      className={cn(
        "aui-thread-scroll-to-bottom absolute -top-12 z-10 self-center rounded-full p-4 dark:border-border dark:bg-background dark:hover:bg-accent",
        isAtBottom && "invisible",
      )}
    >
      <ArrowDownIcon />
    </TooltipIconButton>
